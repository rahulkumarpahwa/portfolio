...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      id="timeline"
      className="w-full bg-inherit font-sans md:px-10 dark:bg-black"
      ref={containerRef}
    >
      <div className="max-w-7xl px-4 pt-40 pb-10 text-center md:px-8 lg:px-10">
        <h2 className="align-center mb-4 flex max-w-4xl animate-bounce justify-center font-sans text-4xl text-black italic md:text-7xl dark:text-white">
          <IoMdClock />
          Timeline
        </h2>
        <div className="text-center text-sm text-neutral-700 md:text-xl dark:text-neutral-300">
